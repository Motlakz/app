        ...
        <section className="contact flex items-stretch p-8">
            ...
            <section className="right flex-1">
                <div className="relative sm:max-w-xl sm:mx-auto">
                    <form className="form-group relative p-8 bg-white mx-8 md:mx-0 shadow rounded-3xl">
                        ...
                        <ul className="divide-y divide-gray-200 mt-4">
                            <li className="py-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
